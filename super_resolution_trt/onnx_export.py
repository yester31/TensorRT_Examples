...
def main():
    ...
    parser.add_argument('-i', '--input', type=str, default='inputs/0014.jpg', help='Input image or folder')
    parser.add_argument(
        '-n',
        '--model_name',
        type=str,
