...
def main():
    ...
    # Input
    img_path = f'{CUR_DIR}/data/test_82.jpg'
    ...
    onnx_model_path = os.path.join(CUR_DIR, 'onnx', f'skyseg.onnx')
    engine_file_path = os.path.join(CUR_DIR, 'engine', f'skyseg_{model_name}_{precision}.engine')
    os.makedirs(os.path.dirname(engine_file_path), exist_ok=True)

    # Output shapes expected
    output_shapes = [(1,320,320)]
    ...
    t_result = (t_result * 255.0).round().astype(np.uint8)
