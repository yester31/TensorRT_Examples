...
def main():
    ...
    onnx_model_path = os.path.join(current_directory, 'onnx', f'{model_name}_{device.type}_sparsity_bf.onnx')
    engine_file_path = os.path.join(current_directory, 'engine', f'{model_name}_{precision}_sparsity_bf.engine')
    #onnx_model_path = os.path.join(current_directory, 'onnx', f'{model_name}_{device.type}_sparsity.onnx')
    #engine_file_path = os.path.join(current_directory, 'engine', f'{model_name}_{precision}_sparsity.engine')
    # Average FPS: 4886.81 [fps] <- f16 w batch folding
    # Average FPS: 4890.52 [fps] <- sparsity f16 w batch folding
