...
def main():
    ...
    model_name = "resnet18"
    precision = "fp16" # Choose 'int8' or 'fp32' or 'fp16'
    onnx_model_path = os.path.join(CUR_DIR, 'onnx', f'{model_name}_{sparsity_mode}.onnx')
    engine_file_path = os.path.join(CUR_DIR, 'engine', f'{model_name}_{precision}_{sparsity_mode}.engine')
    ...
    with get_engine(onnx_model_path, engine_file_path, precision, TRT_LOGGER) as engine, \
