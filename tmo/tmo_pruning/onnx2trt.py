...
def main():
    ...
    onnx_model_path = os.path.join(CUR_DIR, 'onnx', f'{model_name}_pruned_f{flops_constraints}.onnx')
    engine_file_path = os.path.join(CUR_DIR, 'engine', f'{model_name}_{precision}_pruned_f{flops_constraints}.engine')
