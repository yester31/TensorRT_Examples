...
def main():
    ...
    out = cv2.VideoWriter(f"{CUR_DIR}/results/video_neuflow_trt.mp4", fourcc, 20, (640, 480))
    ...
    with get_engine(onnx_model_path, engine_file_path, precision) as engine, \
        ...
        for imfile1, imfile2 in zip(image_paths[:-1], image_paths[1:]):
            ...
            flow_up = trt_outputs[0].reshape(output_shape) # [1, 2, h, w]
            ...
            image1_bgr = np.transpose(image1[0], (1, 2, 0)) 
